# Interesting things in programming python for beginners
When you first learn python programming, you don't know what's interesting about python. Take a look at the following examples to find the fun in learning python. _[here](https://pythonid.com/user/doan/projects/interesting-things-in-programming-python-for-beginners)_. Learn more about Python concepts _[here](https://pythonid.com/tutorials/python-getting-started)_
# Table of Contents
